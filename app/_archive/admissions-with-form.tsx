/**
 * ALTERNATE ADMISSIONS PAGE — kept for later use.
 *
 * This is the original page: four admission steps (including "Assessment"), a
 * "Book Free Counselling" anchor button and the full EnquiryForm.
 * The live page is `app/admissions/page.tsx` (WhatsApp-led, no form).
 *
 * `app/_archive/` is a private folder — Next.js excludes underscore-prefixed
 * folders from routing, so nothing here is published. To restore, copy this
 * file over `app/admissions/page.tsx` and re-add the "Assessment" step to
 * `admissionSteps` in `lib/data.ts`.
 */
...
export default function AdmissionsPageWithForm() {
  return (
    <>
      <PageHero
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="card flex items-start gap-4 p-5">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[0.9rem] text-muted">
                    SJPS (St John&apos;s), Siruseri and BHIS (Billabong), Kelambakkam — or learn live
                    from anywhere.
                  </p>
                </div>
              </div>
